...
export default function Hero({ user, totalStars, reposCount }) {
  return (
    <section id="about" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      {/* Radial glows — capped so they don't overflow on mobile */}
      <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-xl h-64 md:h-[500px] rounded-full"
          style={{ background: "radial-gradient(circle, rgba(79,142,247,0.08) 0%, transparent 65%)" }} />
        <div className="absolute top-2/3 right-0 w-64 h-64 md:w-80 md:h-80 rounded-full"
          ...
          <motion.div variants={stagger} initial="hidden" animate="show">
            ...
            <motion.div variants={item} className="mb-5 flex flex-wrap items-center gap-x-2 gap-y-1 min-h-[2rem]">
              ...
              <TypeAnimation
                ...
                speed={50}
                repeat={Infinity}
                className="font-display text-lg md:text-2xl text-[#4f8ef7] font-semibold"
              />
            </motion.div>
            ...
            <motion.p variants={item}
              ...
              Architecting claims automation pipelines with AES-256 encryption, SQS FIFO, OCR — cutting claim time by{" "}
